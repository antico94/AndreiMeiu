...
import css from "./construction.module.css"
...
const Construction = () => {
    return (
		...
		C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#64FFDA"/>
                        <animateTransform
                            attributeName="transform"
                            begin="0s"
                            dur="2s"
                ...
                <p className={css.text}>
                    ...
                    The website is not fully functional yet, i am still working on it.
                    You can check my progress <a href={'https://github.com/antico94/AndreiMeiu/tree/main'}>here</a>.
